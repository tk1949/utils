...
public final class BitUtils {
     ...
     *
     * @param pSize    the size of the string date in bit
     ...
     * @param pSize    the size of the string date in bit
     * @param pPattern the Date pattern
     * @param pUseBcd  get the Date with BCD format (Binary coded decimal)
     * @return a date object or null
     */
     ...
     *
     * @param pSize    the length of the string int bit
     ...
     * @param pValue   the value to write
     * @param pPattern the Date pattern
     * @param pUseBcd  write date as BCD (binary coded decimal)
     */
