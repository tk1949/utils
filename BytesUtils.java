...
public final class BytesUtils {
     ...
     *
     * @param byteArray byte array to convert
     * @param startPos  start position in array in the
     ...
     *
     * @param pBytes    Bytes to convert
     * @param pTruncate true to remove 0 left byte value
     * @return a string
     */
     ...
     *
     * @param pVal      value to test
     * @param pBitIndex bit index between 0 and 31
     ...
     * @param pBitIndex index to set
     * @param pOn       set bit at specified index to 1 or 0
